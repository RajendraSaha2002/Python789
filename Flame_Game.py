...
def remove_match_char(list1, list2):
    ...
    for i in range(len(list1)):
        for j in range(len(list2)):
            ...
            # and return list of a concatenated
            # list with True Flag
            if list1[i] == list2[j]:
                c = list1[i]
...
if __name__ == "__main__":
    ...
    while proceed:
        ...
        # take out a concatenated list from a return list
        con_list = ret_list[0]

        # take out flag value from a return list
        proceed = ret_list[1]
    ...
    while len(result) > 1:
        ...
        # anticlockwise-wise circular fashion counting.
        if split_index >= 0:
